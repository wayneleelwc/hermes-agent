...
![Hermes 记忆与知识系统 — 封面](./diagrams/01-cover.html)
...
![Hermes 记忆与知识系统全景 — 四层协同运转的知识转化体系](./diagrams/02-architecture-overview.html)
...
![MemoryProvider 生命周期 — 7个核心方法编排时序](./diagrams/03-provider-lifecycle.html)
...
![Provider 对比矩阵 — Honcho 辩证建模 vs Mem0 事实提取](./diagrams/04-provider-comparison.html)
...
![知识转化流水线 — Memory 到 Skill 到 Curator 的三级转化](./diagrams/05-knowledge-pipeline.html)
...
![Skill 生命周期状态机 — 六状态完整闭环](./diagrams/06-skill-lifecycle.html)
...
![Curator 自主审查流程 — 7天周期与三层分类信号](./diagrams/07-curator-process.html)
